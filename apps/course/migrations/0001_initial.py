    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fanv_nums', models.IntegerField(default=0, verbose_name='收藏人数')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='course.Course', verbose_name='章节')),
            ],
            options={
